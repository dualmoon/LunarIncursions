...
public class TestArena1IncursionBiome extends IncursionBiome {
    public TestArena1IncursionBiome() { super("reaper");}
    ...
    public LootTable getBossDrop(final IncursionData incursionData) {
        return new LootTable(new LootItemInterface[]{LootItem.between("shadowessence", 20, 25), new LootItemInterface() {
            ...
            public void addPossibleLoot(LootList lootList, Object... objects) {
                ...
                gatewayTablet.getGndData().setInt("displayTier", TestArena1IncursionBiome.this.increaseTabletTierByX(incursionData.getTabletTier(), 1));
            ...
            public void addItems(List<InventoryItem> list, GameRandom gameRandom, float v, Object... objects) {
                InventoryItem gatewayTablet = new InventoryItem("gatewaytablet");
                GatewayTabletItem.initializeGatewayTablet(gatewayTablet, gameRandom, TestArena1IncursionBiome.this.increaseTabletTierByX(incursionData.getTabletTier(), 1));
    ...
    public IncursionLevel getNewIncursionLevel(LevelIdentifier identifier, BiomeMissionIncursionData incursion, Server server, WorldEntity worldEntity) {
        return new TestArena1IncursionLevel(identifier, incursion, worldEntity);
    }
